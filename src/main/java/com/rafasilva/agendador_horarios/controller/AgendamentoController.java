package com.rafasilva.agendador_horarios.controller;


import com.rafasilva.agendador_horarios.infrastructure.entity.Agendamento;
import com.rafasilva.agendador_horarios.services.AgendamentoService;
...
public class AgendamentoController {
    ...
    public ResponseEntity<Agendamento> alterarAgendamentos(@RequestBody Agendamento agendamento,
                                                           ...
                                                           @RequestParam LocalDateTime dataHoraAgendamento){
        return ResponseEntity.accepted().body(agendamentoService.alterarAgendamentos(agendamento, cliente, dataHoraAgendamento));
    }
}
