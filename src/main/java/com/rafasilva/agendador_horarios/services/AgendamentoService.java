package com.rafasilva.agendador_horarios.services;

import com.rafasilva.agendador_horarios.infrastructure.entity.Agendamento;
import com.rafasilva.agendador_horarios.infrastructure.repository.AgendamentoRepository;
...
public class AgendamentoService {
    ...
    public Agendamento salvarAgendamento(Agendamento agendamento){
        ...
        LocalDateTime horaFim = agendamento.getDataHoraAgendamento().plusHours(1); // Agendar sempre de Hora em Hora
        ...
        if(Objects.nonNull(agendados)){
            throw new RuntimeException("Horario já esta preenchido");
        }
    ...
    public Agendamento alterarAgendamentos(Agendamento agendamento, String cliente, LocalDateTime dataHoraAgendamento){
